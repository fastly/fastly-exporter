...
type Datacenter struct {
	...
	ComputeServiceBackendReqConnRefusedErrorsTotal    uint64            `json:"compute_service_bereq_conn_refused_error"`
	ComputeServiceBackendReqConnTimeoutErrorsTotal    uint64            `json:"compute_service_bereq_conn_timeout_error"`
	ComputeServiceBackendReqDNSErrorsTotal            uint64            `json:"compute_service_bereq_dns_error"`
	ComputeServiceBackendReqErrorsTotal               uint64            `json:"compute_service_bereq_error"`
	ComputeServiceBackendReqHTTPErrorsTotal           uint64            `json:"compute_service_bereq_http_error"`
	ComputeServiceBackendReqHTTPIncompleteErrorsTotal uint64            `json:"compute_service_bereq_http_incomplete_error"`
	ComputeServiceBackendReqHTTPOtherErrorsTotal      uint64            `json:"compute_service_bereq_http_other_error"`
	ComputeServiceBackendReqHTTPProtoV1ErrorsTotal    uint64            `json:"compute_service_bereq_http_proto_v1_error"`
	ComputeServiceBackendReqHTTPProtoV2ErrorsTotal    uint64            `json:"compute_service_bereq_http_proto_v2_error"`
	ComputeServiceBackendReqHTTPTimeoutErrorsTotal    uint64            `json:"compute_service_bereq_http_timeout_error"`
	ComputeServiceBackendReqOtherErrorsTotal          uint64            `json:"compute_service_bereq_other_error"`

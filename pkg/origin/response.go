...
type Stats struct {
	...
	Latency0_1         int `json:"latency_0_to_1ms"`         //	Number of responses from origin with latency between 0 and 1 millisecond.
	Latency1_5         int `json:"latency_1_to_5ms"`         //	Number of responses from origin with latency between 1 and 5 milliseconds.
	Latency5_10        int `json:"latency_5_to_10ms"`        //	Number of responses from origin with latency between 5 and 10 milliseconds.
	Latency10_50       int `json:"latency_10_to_50ms"`       //	Number of responses from origin with latency between 10 and 50 milliseconds.
	Latency50_100      int `json:"latency_50_to_100ms"`      //	Number of responses from origin with latency between 50 and 100 milliseconds.
	Latency100_250     int `json:"latency_100_to_250ms"`     //	Number of responses from origin with latency between 100 and 250 milliseconds.
	Latency250_500     int `json:"latency_250_to_500ms"`     //	Number of responses from origin with latency between 250 and 500 milliseconds.
	Latency500_1000    int `json:"latency_500_to_1000ms"`    //	Number of responses from origin with latency between 500 and 1,000 milliseconds.
	Latency1000_5000   int `json:"latency_1000_to_5000ms"`   //	Number of responses from origin with latency between 1,000 and 5,000 milliseconds.
	Latency5000_10000  int `json:"latency_5000_to_10000ms"`  //	Number of responses from origin with latency between 5,000 and 10,000 milliseconds.
	Latency10000_60000 int `json:"latency_10000_to_60000ms"` //	Number of responses from origin with latency between 10,000 and 60,000 milliseconds.
	Latency60000_inf   int `json:"latency_60000ms"`          // Number of responses from origin with latency of 60,000 milliseconds and above.
}

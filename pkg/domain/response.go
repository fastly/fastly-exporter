...
type Stats struct {
	...
	EdgeHitRatio               uint64 `json:"edge_hit_ratio"`                 //	integer	Ratio of cache hits to cache misses at the edge, between 0 and 1 (edge_hit_requests / (edge_hit_requests + edge_miss_requests)).

...
type Metrics struct {
	...
	ObjectSizeOtherTotal                 *prometheus.CounterVec
...
func NewMetrics(namespace, subsystem string, nameFilter filter.Filter, r prometheus.Registerer) (*Metrics, error) {
	m := &Metrics{
		...
		EdgeRespBodyBytesTotal:               prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "edge_resp_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		EdgeRespHeaderBytesTotal:             prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "edge_resp_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		EdgeTotal:                            prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "edge_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		...
		ImgOptoShieldTotal:                   prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgopto_shield_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		...
		ImgOptoTransformRespBodyBytesTotal:   prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgopto_transform_resp_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgOptoTransformRespHeaderBytesTotal: prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgopto_transform_resp_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgOptoTransformTotal:                prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgopto_transforms_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgVideoFramesTotal:                  prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgvideo_frames_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgVideoRespBodyBytesTotal:           prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgvideo_resp_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgVideoRespHeaderBytesTotal:         prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgvideo_resp_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgVideoShieldFramesTotal:            prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgvideo_shield_frames_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgVideoShieldRespBodyBytesTotal:     prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgvideo_shield_resp_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgVideoShieldRespHeaderBytesTotal:   prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgvideo_shield_resp_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgVideoShieldTotal:                  prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgvideo_shield_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ImgVideoTotal:                        prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "imgvideo_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		...
		LoggingTotal:                         prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "logging_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		MissDurationSeconds:                  prometheus.NewHistogramVec(prometheus.HistogramOpts{Namespace: namespace, Subsystem: subsystem, Name: "miss_duration_seconds", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		...
		OTFPDeliverTimeTotal:                 prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_total", Help: "Number of responses that came from the Fastly On-the-Fly Packager for On Demand Streaming service for video-on-demand."}, []string{"service_id", "service_name", "datacenter"}),
		OTFPManifestTotal:                    prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_deliver_time_total", Help: "Total amount of time spent delivering a response from the Fastly On-the-Fly Packager for On Demand Streaming service for video-on-demand (in seconds)."}, []string{"service_id", "service_name", "datacenter"}),
		...
		OTFPShieldRespBodyBytesTotal:         prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_resp_header_bytes_total", Help: "Total header bytes delivered from the Fastly On-the-Fly Packager for On Demand Streaming service for video-on-demand."}, []string{"service_id", "service_name", "datacenter"}),
		OTFPShieldRespHeaderBytesTotal:       prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_shield_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OTFPShieldTimeTotal:                  prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_shield_resp_body_bytes_total", Help: "Total body bytes delivered via a shield for the Fastly On-the-Fly Packager for On Demand Streaming service for video-on-demand."}, []string{"service_id", "service_name", "datacenter"}),
		...
		OTFPTransformRespBodyBytesTotal:      prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_transforms_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OTFPTransformRespHeaderBytesTotal:    prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_transform_resp_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OTFPTransformTimeTotal:               prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_transform_resp_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OTFPTransformTotal:                   prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "otfp_transform_time_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ObjectSizeBytes:                      prometheus.NewHistogramVec(prometheus.HistogramOpts{Namespace: namespace, Subsystem: subsystem, Name: "object_size_bytes", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ObjectSizeOtherTotal:                 prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "object_size_other_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OriginFetchBodyBytesTotal:            prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "origin_fetch_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OriginFetchHeaderBytesTotal:          prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "origin_fetch_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OriginFetchRespBodyBytesTotal:        prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "origin_fetch_resp_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OriginFetchRespHeaderBytesTotal:      prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "origin_fetch_resp_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OriginFetchesTotal:                   prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "origin_fetches_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		OriginRevalidationsTotal:             prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "origin_revalidations_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		...
		SegBlockOriginFetchesTotal:           prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "segblock_origin_fetches_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		SegBlockShieldFetchesTotal:           prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "segblock_shield_fetches_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ShieldFetchBodyBytesTotal:            prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "shield_fetch_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ShieldFetchHeaderBytesTotal:          prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "shield_fetch_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ShieldFetchRespBodyBytesTotal:        prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "shield_fetch_resp_body_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ShieldFetchRespHeaderBytesTotal:      prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "shield_fetch_resp_header_bytes_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		ShieldFetchesTotal:                   prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "shield_fetches_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
		...
		ShieldRevalidationsTotal:             prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: namespace, Subsystem: subsystem, Name: "shield_revalidations_total", Help: "TODO"}, []string{"service_id", "service_name", "datacenter"}),
...
func Process(response *APIResponse, serviceID, serviceName, serviceVersion string, m *Metrics) {
	for _, d := range response.Data {
		for datacenter, stats := range d.Datacenter {
			...
			m.ObjectSizeOtherTotal.WithLabelValues(serviceID, serviceName, datacenter).Add(float64(stats.ObjectSizeOther))

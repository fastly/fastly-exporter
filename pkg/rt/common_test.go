...
var expectedRTMetricsAggOutputMap = map[string]float64{
	...
	`testspace_testsystem_vcl_on_compute_edge_hit_requests_total{datacenter="aggregate",service_id="my-service-id",service_name="my-service-name"}`:       0,
	`testspace_testsystem_vcl_on_compute_edge_miss_requests_total{datacenter="aggregate",service_id="my-service-id",service_name="my-service-name"}`:      0,
	`testspace_testsystem_vcl_on_compute_error_requests_total{datacenter="aggregate",service_id="my-service-id",service_name="my-service-name"}`:          0,
	`testspace_testsystem_vcl_on_compute_hit_requests_total{datacenter="aggregate",service_id="my-service-id",service_name="my-service-name"}`:            0,
	`testspace_testsystem_vcl_on_compute_miss_requests_total{datacenter="aggregate",service_id="my-service-id",service_name="my-service-name"}`:           0,
	`testspace_testsystem_vcl_on_compute_pass_requests_total{datacenter="aggregate",service_id="my-service-id",service_name="my-service-name"}`:           0,
	`testspace_testsystem_vcl_on_compute_synth_requests_total{datacenter="aggregate",service_id="my-service-id",service_name="my-service-name"}`:          0,
